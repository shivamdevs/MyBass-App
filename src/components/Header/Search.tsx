        ...
        <Routes>
            ...
            <Route path="/*" element={
                <button className="bg-[#fff1] hover:bg-[#fa63] focus-visible:bg-[#fa63] transition-all flex flex-nowrap items-center flex-1 max-w-lg rounded-lg overflow-hidden relative h-12" onClick={() => navigate("/search")}>
                    ...
                    <span className="bg-transparent w-full outline-none absolute inset-0 pl-14 inline-flex items-center justify-start border border-transparent">Search for songs, playlists, artists, etc...</span>
                </button>
            } />
        </Routes>
    );
